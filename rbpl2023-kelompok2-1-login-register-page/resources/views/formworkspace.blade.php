        ...
        <div class="content col-md-10">
            <div class="form-box">
                <div class="flex-column mt-5">
                    <div class="container">
                        <a href="/dashboardworkspace" class="ml-4 mb-5" id="back-button" role="button">Back</a>
                    </div>
                </div>
                        ...
                        <form action="/workspace/form/store" method="post">
                            ...
                            <div class="form-group m-4">
                                ...
                                <input type="ws_desc" class="form-control" id="Description"
                                    placeholder="Enter your workpsace description" name="Description" required
                                    aria-required="true" required="required">
                            </div>
                            <div class="felx-row d-flex justify-content-between">
                                <div class="form-group m-4">
                                    <label for="ws_deadline" id="input-title">Deadline:</label>
                                    <input type="ws_deadline" class="form-control" id="Deadline"
                                        placeholder="DD/MM/YY" name="Deadline" required aria-required="true"
                                        required="required">
                                </div>
                                <div class="form-group m-4">
